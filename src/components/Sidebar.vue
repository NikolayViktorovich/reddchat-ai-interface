<template>
  <div class="w-72 h-full glass-sidebar flex flex-col rounded-3xl border border-white/20 mr-0 lg:mr-3 font-light">
    <div class="px-5 pt-10 pb-8 text-center">
      ...
      <p class="text-white/30 text-[10px] uppercase tracking-[0.2em] mt-3">ai assistant</p>
    </div>
    
    <div class="flex-1 overflow-y-auto scrollbar-thin py-2">
      <button
        @click="$emit('new-chat')"
        class="w-full flex items-center gap-3 px-4 py-2.5 text-gray-300 hover:text-white active:text-white/80 transition-colors duration-150 text-sm"
      >
      ...
      <button class="w-full flex items-center gap-3 px-4 py-2.5 text-gray-300 hover:text-white active:text-white/80 transition-colors duration-150 text-sm" @click="$emit('show-history')">
        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <button class="w-full flex items-center gap-3 px-4 py-2.5 text-gray-300 hover:text-white active:text-white/80 transition-colors duration-150 text-sm" @click="$emit('show-image-generator')">
        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <button class="w-full flex items-center gap-3 px-4 py-2.5 text-gray-300 hover:text-white active:text-white/80 transition-colors duration-150 text-sm" @click="$emit('show-document-analyzer')">
        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
